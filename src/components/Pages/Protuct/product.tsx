...
export function PageProduct(props : PageProductProps){
    return(
        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-2 w-full mb-20">
            ...
            <div className="w-ful md:w-1/2 h-[600px]">
            ...
            <div className="w-ful md:w-1/2 flex flex-col justify-between gap-8  h-[600px] bg-[#eeeeee] px-6 md:px-4 lg:px-8 pt-6 pb-10"> 
